...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/arg4_.jpg" data-stellar-background-ratio=".5">
					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Рекламный буклет фитнес-центра "АрGУМент"
<br><br><p>Задача: разработать дизайн буклета с отличительными особенностями для нового фитнес-центра, <br>который сможет подробно донести информацию до клиентов </p>

					
								
								<ul class="post-meta small"></ul>
								<footer class="post-footer"></footer>
								<br><img class="img-responsive" src="assets/images/arg3_.jpg" alt="" />
								<br><img class="img-responsive" src="assets/images/arg1_.jpg" alt="" />
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/arg2_.jpg" data-stellar-background-ratio=".3">
