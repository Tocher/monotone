...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/calendar_prewie1.jpg" data-stellar-background-ratio=".5">
					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Календарь для страховой компании "АСБ Лизинг"
<br><br><p>Задача: разработать дизайн-макет, для использования календаря в разных форматах, <br>который отражает направление лизинноговой компании</p>
								...
								<br><img class="img-responsive" src="assets/images/calendar_prewie2.jpg" alt="" />
											<br><img class="img-responsive" src="assets/images/calendar_prewie5.jpg" alt="" />
							</header>
							<footer class="post-footer"></footer>
							</article>
						</div>
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/calendar_prewie3.jpg" data-stellar-background-ratio=".3">
