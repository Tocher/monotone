$(document).ready(function() {
	...
	$('a.scrollto').click(function(e){
		var navHeight = $('#main-nav').height(),
			toggleHeight = $('#toggle-map').height();
			console.log(toggleHeight);
		$('html,body').scrollTo(this.hash, this.hash, {gap: {y: this.hash=='#contact'? -(navHeight) : -navHeight} ,animation:  {easing: 'easeInOutCubic', duration: 1000}});
		e.preventDefault();
