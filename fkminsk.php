					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Концепция и дизайн билборда для футбольного клуба "Минск"
<ul class="post-meta small"></ul>
								<footer class="post-footer"></footer>
								<p>Задача: разработать идею и яркий, красочный дизайн для привлечения детей в футбольный клуб "Минск"</p>
							
									<br><img class="img-responsive" src="assets/images/Billboard_FKMinsk.jpg" alt="" />
						</header>
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/fk_prewie.jpg" data-stellar-background-ratio=".3">
