...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/kyliss_logo6.jpg" data-stellar-background-ratio=".5">
					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Логотип для студии красоты "ЛяКулисс"
<br><br><p>Задача: разработать современный логотип, который своей графикой сможет подчеркнуть стилистику студии</p>

								<ul class="post-meta small"></ul>
								<footer class="post-footer"></footer>
								<img class="img-responsive" src="assets/images/kuliss_logo8.jpg" alt="" />
							
								<br><img class="img-responsive" src="assets/images/kyliss_logo7.jpg" alt="" />
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/kyliss_logo4.jpg" data-stellar-background-ratio=".3">
