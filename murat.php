...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/murat_prewie2.jpg" data-stellar-background-ratio=".5">
					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Имиджевый буклет для продюсерской компании Мурата Абдульманова
<br><br><p>Задача: Разработать буклет с информацией о букинге артистов <br>Буклет разработан с учетом нового логотипа компании, выполнен с отличительными графическими элементами</p>

					
								
								<ul class="post-meta small"></ul>
								<footer class="post-footer"></footer>
								<img class="img-responsive" src="assets/images/murat_prewie4.jpg" alt="" />
							<br><img class="img-responsive" src="assets/images/sdj_prewie5.jpg" alt="" />
	</header>
							<footer class="post-footer"></footer>
							</article>
						</div>
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/muret_prewie2.jpg" data-stellar-background-ratio=".3">
