...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/robingood.jpg" data-stellar-background-ratio=".5">
...
<br><br><p>Задача: разработать логотип, который будет отображать стилистику кавер бэнда</p>
								...
								<img class="img-responsive" src="assets/images/01_businesscard.jpg" alt="" />
							
								<br><img class="img-responsive" src="assets/images/03_businesscard.jpg" alt="" />
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/02_businesscard.jpg" data-stellar-background-ratio=".3">
