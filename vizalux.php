...
<?php include('menu.php'); ?>
		...
		PPHTO SLICDE
		=============================================== -->			
		<section class="parallax-bg light-typo padding-top-bottom3" data-parallax-background="assets/images/vizalux2.jpg" data-stellar-background-ratio=".5">
					...
					<div id="single-post" class="col-sm-12">
						...
						<article class="post-entry">
							...
							<header class="post-header">
                                   <br><br><h3 class="text-center">Логотип для визового агенства "VizaLux"
<br><br><p>Задача: разработать узнаваемый логотип <br>Знак представляет собой букву z, контуры которых создают стилисзованный флаг. Надпись же выполнена жирным и основательным гротескным шрифтом, который соответствует ритму самого названия.</p>

					
								
								<ul class="post-meta small"></ul>
								<footer class="post-footer"></footer>
								<img class="img-responsive" src="assets/images/vizalux3.jpg" alt="" />
		...
		<header id="home" class="parallax-bg" data-parallax-background="assets/images/vizalux.jpg" data-stellar-background-ratio=".3">
