...
<br><br><p>Задача: разработать узнаваемый логотип <br>Знак представляет собой букву z, контуры которых создают стилизованный флаг. Надпись же выполнена жирным и основательным гротескным шрифтом, который соответствует ритму самого названия.</p>
